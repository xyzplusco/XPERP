...
import { getAssignablePeople, getProjectOptions, getTask } from "@/lib/queries";
...
export default async function TaskDetailPage({
  ...
  const updateAction = updateTaskDetailAction.bind(null, id);

  return (
    <>
      <div className="detailHeader">
        <div className="detailKicker">
          <Link href="/tasks">과제</Link> / {shortId("T", id)}
        </div>
      ...
      <div className="panel">
        <div className="panelHeader">
          <div className="panelTitle">과제 정보</div>
          <form action={deleteTaskAction.bind(null, id, "/tasks")}>
